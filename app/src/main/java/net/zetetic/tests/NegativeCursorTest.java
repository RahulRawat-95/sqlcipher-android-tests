...
public class NegativeCursorTest extends SQLCipherTest {
    ...
    public boolean execute(SQLiteDatabase database) {
        ...
        Cursor cursorNegativeOne = database.query(true,"ChildEntity",null,"parentId = ? or ? = -1;", new String[]{"-1","-1"},null,null,null,null);
